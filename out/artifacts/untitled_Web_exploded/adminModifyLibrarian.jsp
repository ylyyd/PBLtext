						...
						<div class="panel-body">
							<table align="center">
								<tr>
									<td width=250px height=64px>
										<div class="form-group has-success has-feedback">
											<label class="control-label" for="librarianId">图书管理员ID</label>
										</div>
									</td>
								...
								<tr>
									<td width=250px height=64px>
										<div class="form-group has-success has-feedback">
											<label class="control-label" for="librarianname">图书管理员新姓名</label>
										</div>
									</td>
								...
								<tr>
									<td width=250px height=64px>
										<div class="form-group has-success has-feedback">
											<label class="control-label" for="librarianname">图书管理员账户状态</label>
										</div>
									</td>
	...
	<script type="text/javascript">
		...
		function inputCheck(form) {
			if (!isName.test(form.LibrarianName.value)) {
				alert("图书管理员姓名必须使用英文或中文字符，少于50个字母且不能为空，请重新输入！");
