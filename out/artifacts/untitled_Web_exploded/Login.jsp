			...
			<div class="auth-box ">
						...
						<form class="form-auth-small" method="post" action="LoginHandler">
							<table align="center">
								<tr>
									<td width=150px height=64px>
										<div class="form-group has-success has-feedback">
											<label class="control-label" name="userID">用户ID</label>
										</div>
									</td>
								...
								<tr>
									<td width=150px height=64px>
										<div class="form-group has-success has-feedback">
											<label class="control-label" name="password">密码</label>
										</div>
									</td>
									<td width=350px height=64px>
										<div class="form-group has-success has-feedback">
											<c:if test="${not empty password }">
												<input type="password" name="password" id="pw"
													   class="form-control" placeholder="密码" maxlength="32"
													   value="${password }">
											</c:if>
									...
									<td>
										<div class="form-group clearfix" align="left">
											<c:if test="${empty authority }">
												<input type="radio" name="authority" value="reader" checked />我是读者 <br />
												<input type="radio" name="authority" value="librarian" />我是图书管理员 <br />
												<input type="radio" name="authority" value="administrator" />我是管理员 <br />
											</c:if>
											<c:if test="${not empty authority }">
												...
												<c:if test="${authority eq 'librarian' }">
													<input type="radio" name="authority" value="reader" />我是读者 <br />
													<input type="radio" name="authority" value="librarian" checked/>我是图书管理员 <br />
													<input type="radio" name="authority" value="administrator" />我是管理员 <br />
												</c:if>
												<c:if test="${authority eq 'administrator' }">
													<input type="radio" name="authority" value="reader" />我是读者 <br />
													<input type="radio" name="authority" value="librarian" />我是图书管理员 <br />
													<input type="radio" name="authority" value="administrator" checked/>我是管理员 <br />
												</c:if>
											</c:if>
				...
				<div class="right">
					...
					<div class="content text">
						<h1 align="center" class="heading">欢迎使用在线图书管理系统！</h1>
					</div>
				</div>
