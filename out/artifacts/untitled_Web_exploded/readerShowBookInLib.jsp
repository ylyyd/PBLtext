						...
						<div class="panel">
							...
							<div class="panel-body">
								...
								<div class="panel">
									...
									<div class="panel-body">
										ISBN:<input type="text" class="form-control"
													...
													value="${BookDetail.ISBN }" /> <br> 书名: <input
								...
								<nav>
									...
									<ul class="pager">
										<li><a
												href="?start=0&bookInfoISBN=${sessionScope.bookInfoISBN }">首页</a></li>
										<li><a
										...
										<li><a
												href="?start=${last}&bookInfoISBN=${sessionScope.bookInfoISBN }">末页</a></li>
									</ul>
								</nav>
							</div>
						</div>
