						...
						<div class="panel-body">
							<table align="center">
								<tr>
									<td width=250px height=64px>
										<div class="form-group has-success has-feedback">
											<label class="control-label" for="librarianName">管理员ID</label>
										</div>
									</td>
								...
								<tr>
									<td width=250px height=64px>
										<div class="form-group has-success has-feedback">
											<label class="control-label" for="librarianName">新管理员姓名</label>
										</div>
									</td>
									<td width=350px height=64px>
										<div class="form-group has-success has-feedback">
	...
	<script type="text/javascript">
		...
		function inputCheck(form) {
			if (!isName.test(form.adminName.value)) {
				alert("管理员姓名必须使用英文或中文字符，少于50个字母且不能为空，请重新输入！");
				form.adminName.focus();
				return false;
			}
			if (!isPassword.test(form.Password.value)) {
				alert("密码必须少于50个字符或留空，请重新输入！");
				form.Password.focus();
				return false;
			}
